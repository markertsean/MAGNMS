...
long long setPartFile( inputInfo &userInput ) { //All the user input
  ...
  sprintf(testPartFile, "%s%4.4i.%4.4i.%4.4i.DAT"       , partFileStart.c_str(), snapNum, userInput.getPMssFirstNum(), userInput.getPMssLastNum() );
  sprintf(testHeadFile, "%s%4.4i.%4.4i.%4.4i.header.dat", partFileStart.c_str(), snapNum, userInput.getPMssFirstNum(), userInput.getPMssLastNum() );
